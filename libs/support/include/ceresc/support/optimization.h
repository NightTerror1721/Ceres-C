...
namespace ceresc::support
{
	...
	struct OptimizationOptions
	{
		...
		bool loopIdioms = true;					// turn a byte fill/copy/search loop into a call to a word-at-a-time routine
	...
	inline std::span<const OptimizationFlag> optimizationFlags() noexcept
	{
		static constexpr OptimizationFlag kFlags[] = {
			...
			{ "loop-idioms",        &OptimizationOptions::loopIdioms,               "lower a byte fill/copy/search loop to a word-at-a-time routine the back end emits" },
